...
class DatabaseController extends GetxController{
  ...
  void newProd(data){
    dbRef.child("Productos").push().set(data).then((value)=>print("Producto agregado")).catchError((onError)=>print("Error al intentar agregar el producto $onError"));
  }
  ...
  void updProd(key, data){
    dbRef.child("Productos").child(key).update(data).then((value){
      ...
      productos.insert(index, Producto(key: key, prodData: ProdData.fromJson(data)));
    });
  }
  ...
  void newCoti(data){
    dbRef.child("Cotizaciones").push().set(data).then((value)=>print("Cotizacion agregada")).catchError((onError)=>print("Error al intentar agregar la cotizacion $onError"));
  }
  ...
  void getCotis(){
    dbRef.child("Cotizaciones").onChildAdded.listen((data) {
      ...
      Cotizacion cotizacion = Cotizacion(key: data.snapshot.key, cotiData: cotiData);
  ...
  void updCoti(key, data){
    dbRef.child("Cotizaciones").child(key).update(data).then((value){
      ...
      cotizaciones.insert(index, Cotizacion(key: key, cotiData: CotiData.fromJson(data)));
  });
  }
  ...
  void newClient(data){
    dbRef.child("Clientes").push().set(data).then((value)=>print("Cliente agregado")).catchError((onError)=>print("Error al intentar agregar el cliente $onError"));
  }
  ...
  void updClient(key, data){
    dbRef.child("Clientes").child(key).update(data).then((value){
      ...
      clientes.insert(index, Cliente(key: key, clientData: ClientData.fromJson(data)));
    });
  }
  ...
  void newSeller(data){
    dbRef.child("Vendedores").push().set(data).then((value)=>print("Vendedor agregado")).catchError((onError)=>print("Error al intentar agregar el vendedor $onError"));
  }
  ...
  void updSeller(key,data){
    dbRef.child("Vendedores").child(key).update(data).then((value){
      ...
      vendedores.insert(index, Vendedor(key: key, sellData: SellData.fromJson(data)));
    });
  }
